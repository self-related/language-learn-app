...
export default function Output({ translatedWord, onOutputChange, onOutputReset}: OutputProps) {
    ...
    <div id="output-div" className="mt-4">
        ...
        <div className="flex justify-end">
            <button onClick={onOutputReset}
                className='px-2 mr-2 bg-gray-700 hover:bg-gray-600 active:bg-gray-800 accent-orange-400 outline-orange-400 focus:outline-2 cursor-pointer rounded-sm'
            >Reset
            </button>
